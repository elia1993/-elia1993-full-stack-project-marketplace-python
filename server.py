...
def root():
    ...
    return render_template('index.html', user=user, owners=owners, categories=list(set(categories)),
                           cutomers_likes=cutomers_likes, var=template)
...
if __name__ == '__main__':
    app.run(host='0.0.0.0', port=5005)  # Change the port number as needed
